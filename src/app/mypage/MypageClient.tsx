...
export default function MypageClient({
  ...
  // 記録店舗導線: privateアクセス作成が新しい3件だけ表示する
          ...
          <Card as="section" className="p-6">
            ...
            {profile ? (
              <div className="space-y-5">
                <div>
                  <p className="mb-2 text-xs font-medium text-ink-sub">
                    タイプ
                  </p>
                ...
                <div>
                  <div className="mb-1.5 flex items-center justify-between">
                    ...
                    <p className="text-xs tabular-nums text-ink-sub">
                      {confidencePct}%
                    </p>
                  </div>
          ...
          <Card as="section" className="p-6">
            ...
            {myReviews.length === 0 ? (
              <div className="py-2 text-center">
                <p className="mb-1.5 text-2xl" aria-hidden="true">
                  📝
                </p>
          ...
          <Card as="section" className="p-6">
            ...
            {myRestaurants.length > 0 && (
              <Link
                ...
                className="mt-4 inline-flex min-h-[44px] w-full items-center justify-center border-t border-edge pt-4 text-sm font-medium text-terra transition-colors hover:text-terra-deep"
              >
                記録の追加をする・記録している店舗をすべて見る（
                {myRestaurants.length}件）
              </Link>
            )}
          </Card>
